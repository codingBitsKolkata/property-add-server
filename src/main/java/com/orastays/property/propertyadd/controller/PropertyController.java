...
public class PropertyController extends BaseController{
	...
	@RequestMapping(value = "/property-type", method = RequestMethod.GET, produces = "application/json")
	@ApiOperation(value = "Property Type Listing", response = ResponseModel.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK"),
			@ApiResponse(code = 201, message = "Please Try after Sometime!!!") })
	public ResponseEntity<ResponseModel> fetchPropertyTypeList(@RequestParam String languageId) {
		...
		try {
			...
			List<PropertyTypeModel> propertyTypeModels = propertyService.fetchAllPropertyTypeByLanguage(languageId);
