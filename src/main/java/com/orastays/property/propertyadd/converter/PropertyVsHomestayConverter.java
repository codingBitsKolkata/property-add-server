...
@Component
public class PropertyVsHomestayConverter extends CommonConverter
	...
	private static final Logger logger = LogManager.getLogger(PropertyVsHomestayConverter.class);
